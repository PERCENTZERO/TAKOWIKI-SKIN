			...
			<ul class="nav navbar-nav">
				<li class="nav-item">
					<?php echo Linker::linkKnown(
						...
						'<span class="fas fa-sync"></span><span class="hide-title">방금 수정♡</span>',
				...
				<li class="nav-item">
					<?php echo Linker::linkKnown(
						...
						// @codingStandardsIgnoreStart
						'<span class="fa fa-random"></span><span class="hide-title">랜덤문서의 그녀</span>',
						// @codingStandardsIgnoreEnd
						[
							'class' => 'nav-link',
				...
				<li class="nav-item">
					<?php echo Linker::linkKnown(
						...
						// @codingStandardsIgnoreStart
						'<span class="fa fa-upload"></span><span class="hide-title">파1 업로드</span>',
						// @codingStandardsIgnoreEnd
						[
							'class' => 'nav-link',
							'title' => Linker::titleAttrib( 'n-uploadpage', 'withaccess' ),
							'accesskey' => Linker::accesskey( 'n-uploadpage' )
						]
					); ?>
				</li>
